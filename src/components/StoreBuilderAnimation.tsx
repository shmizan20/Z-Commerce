        ...
        <div className="relative min-h-[500px] lg:min-h-[580px]">
          ...
          >
            <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-black/10 border border-white/60 overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-2.5 px-4 sm:px-6 mt-4">
                {[
                   ...
                   <div key={idx} className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between gap-1 mb-0.5">
                          <span className="text-[8px] font-bold text-gray-400 truncate">{s.label}</span>
                          <span className="text-[7px] font-black text-green-500 bg-green-50 px-1 py-0.5 rounded whitespace-nowrap">{s.add}</span>
                        </div>
                        <p className="text-base font-black text-[#1A1C20] tracking-tight">{s.val}</p>
                      </div>
                   </div>
                ))}
              </div>
